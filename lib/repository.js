...
Repository.prototype.storeEvent = function(aggregateId, name, attrs, callback) {
  var self = this;

  this.strategy.storeEvent(aggregateId, name, attrs, function(event) {
    var handlers = self.handlers[name];
