var repo = require('./repository').getInstance(),
    storage = require('./storage/couch').getInstance();
 ...
 *   the memory.
 */
module.exports = View = function(eventNames) {
...
View.prototype.load = function(callback) {
  ...
  // repo.getEventsByName(this.eventNames, function(events) {
  ...
  //   // Make a snapshot and save it to view store.
  // });
}
